...
public class VentanaProfesor extends JFrame {
    private int finalIdProfesor =1;

    public VentanaProfesor(int idUsuario) {
        finalIdProfesor = idUsuario;
        setTitle("Panel del Alumno - " + finalIdProfesor);
        ...
        gbc.gridx = 0;
        JButton b1 = crearBoton("Ver calendario", "calendario.png");

        b1.addActionListener(e -> new VerCalendario(this, finalIdProfesor));
        panelCentral.add(b1, gbc);

        gbc.gridx = 1;
        JButton b2 = crearBoton("Añadir maniobra a alumno", "usuarioV.png");
        b2.addActionListener(e -> new ManiobraAlumno(this, finalIdProfesor));
